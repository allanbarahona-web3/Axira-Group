...
import { getProperties, getPropertyBySlug } from "@/modules/real-estate/provider";
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <p className="text-xl text-neutral-600 mb-6">{property.location}</p>
              <p className="text-4xl font-semibold text-primary mb-8">{property.price}</p>
