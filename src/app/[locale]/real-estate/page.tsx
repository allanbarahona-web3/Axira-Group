    ...
    <div className="section-padding">
      <div className="container-custom">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-xl">{translate(messages, "realEstate.subtitle")}</p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {properties.map((property) => (
            ...
            >
              <div className="aspect-[4/3] bg-neutral-200 relative overflow-hidden">
                ...
                <div className="absolute top-4 right-4 px-3 py-1 bg-white/90 backdrop-blur-sm rounded-full text-sm font-medium z-10">
                  <span className={
                    ...
                    property.status === "reserved" ? "text-amber-600" :
                    "text-neutral-600"
                  }>
              ...
              <div className="p-6">
                <h3 className="text-xl mb-2 group-hover:text-accent transition-colors">{property.title}</h3>
                <p className="text-neutral-600 text-sm mb-3">{property.location}</p>
                <p className="text-2xl font-semibold text-primary mb-4">{property.price}</p>
