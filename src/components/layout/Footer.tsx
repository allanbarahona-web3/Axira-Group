          ...
          <div className="grid md:grid-cols-4 gap-12">
            ...
            <div className="md:col-span-1">
              ...
              <p className="text-neutral-300 text-sm mt-4">
                Premier advisory and property services for international
                business.
              </p>
              <div className="flex items-center gap-2 mt-5">
                {socials.tiktok ? (
                  <a
                    ...
                    className="p-2.5 rounded-full text-neutral-100 hover:text-accent-light transition-colors"
                    aria-label="TikTok"
                  >
                    <TikTokIcon />
                  </a>
                  ...
                  <span
                    className="p-2.5 rounded-full text-neutral-300 bg-white/10"
