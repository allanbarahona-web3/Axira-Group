        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="flex items-center space-x-4">
            <div className="hidden md:flex items-center gap-2">
              {socials.tiktok ? (
                <a href={socials.tiktok} target="_blank" rel="noopener noreferrer" className="p-2.5 rounded-full text-neutral-700 hover:text-primary-dark transition-colors" aria-label="TikTok">
                  <TikTokIcon />
                </a>
              ) : (
                <span className="p-2.5 rounded-full text-neutral-600 bg-neutral-100" aria-label="TikTok unavailable">
                  <TikTokIcon />
                </span>
              )}
              {socials.instagram ? (
                <a href={socials.instagram} target="_blank" rel="noopener noreferrer" className="p-2.5 rounded-full text-neutral-700 hover:text-primary-dark transition-colors" aria-label="Instagram">
                  <InstagramIcon />
                </a>
              ) : (
                <span className="p-2.5 rounded-full text-neutral-600 bg-neutral-100" aria-label="Instagram unavailable">
                  <InstagramIcon />
                </span>
              )}
              {socials.facebook ? (
                <a href={socials.facebook} target="_blank" rel="noopener noreferrer" className="p-2.5 rounded-full text-neutral-700 hover:text-primary-dark transition-colors" aria-label="Facebook">
                  <FacebookIcon />
                </a>
              ) : (
                <span className="p-2.5 rounded-full text-neutral-600 bg-neutral-100" aria-label="Facebook unavailable">
                  <FacebookIcon />
                </span>
              )}
            </div>
