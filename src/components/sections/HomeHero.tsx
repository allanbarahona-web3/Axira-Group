...
export default function HomeHero({ locale, messages }: HomeHeroProps) {
  return (
    <section className="relative min-h-[100svh] overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-r from-[#0b1220]/72 via-[#0b1220]/45 to-[#0b1220]/18" />
      ...
      <div className="relative min-h-[100svh] flex items-center">
        <div className="w-full max-w-6xl mx-auto px-6 sm:px-8 py-24">
          <div className="max-w-3xl">
            ...
            <div className="mt-8 inline-flex items-center rounded-xl border border-white/20 bg-white/5 px-4 py-2 text-white/80 text-sm sm:text-base">
            ...
            <div className="mt-8 flex flex-col sm:flex-row gap-4">
              <Link
                href={`/${locale}/contact`}
                className="inline-flex items-center justify-center rounded-xl px-7 py-4 text-lg font-semibold bg-[#b8860b] hover:bg-[#9f740a] text-white transition-colors"
              >
