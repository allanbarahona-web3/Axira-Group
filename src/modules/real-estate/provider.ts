...
const mockProperties: Property[] = [
  {
    ...
    description:
      "Exquisite penthouse apartment with panoramic sea views in the heart of Marbella's Golden Mile. Features include a private terrace, infinity pool, and premium finishes throughout.",
    type: "penthouse",
    status: "available",
    price: "€2,850,000",
  ...
  },
  {
    ...
    description:
      "Contemporary architectural masterpiece located in the prestigious Quinta do Lago area. This stunning villa offers the perfect blend of luxury and comfort.",
    type: "villa",
    status: "available",
    price: "€3,200,000",
  ...
  },
  {
    ...
    description:
      "Sophisticated beachfront residence in Dubai Marina with stunning views of the Arabian Gulf. Premium amenities and world-class finishes.",
    type: "apartment",
    status: "reserved",
    price: "AED 5,900,000",
  ...
  },
  {
    ...
    description:
      "Prime development land in Son Vida, Mallorca's most exclusive residential area. Excellent investment opportunity with approved building permits.",
    type: "land",
    status: "available",
    price: "€1,750,000",
  ...
  },
  {
    ...
    description:
      "Beautifully restored townhouse in Lisbon's historic Chiado district. Combines traditional Portuguese charm with modern luxury amenities.",
    type: "townhouse",
    status: "sold",
    price: "€1,450,000",
  ...
  },
  {
    ...
    description:
      "Prime retail unit in London's prestigious Mayfair district. High foot traffic area with excellent visibility and transport links.",
    type: "commercial",
    status: "available",
    price: "£4,500,000",
...
export async function getProperties(): Promise<Property[]> {
  if (isSanityConfigured()) {
    try {
      const properties =
        await sanityClient.fetch<SanityProperty[]>(PROPERTIES_QUERY);
